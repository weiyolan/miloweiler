    ...
    <div style={{ transform: 'translate3d(0,0,0)' }} className='w-full h-screen top-0 titleContainer fixed'>
      <Parallax xs scope={'Title'} timeline={scrubTl} duration={1} className={`titleContainerInner w-full h-full relative`}>
        ...
        {/* <Text animationName='depth3Title' className={'cursor-default font-serif depth2  titleText opacity-0 titleText2 scale-90'} fill="#FFF5EA" style={{ whiteSpace: "pre" }} fontSize="52.5204" letterSpacing="0em">
          ...
          <Text animationName='depth1Title' className={'cursor-default font-serif depth3  titleText opacity-0 titleText2 scale-90'} fill="#FFF5EA" style={{ whiteSpace: "pre" }} fontSize="75" letterSpacing="0em">
            <tspan className={`${shadow ? 'drop-shadow-[0_0px_20px_#FFF5EAFF] ' : ''}`} x="161.107" y="174.07">
              {locale === 'en' ? 'emotive' : 'sensible'}
            </tspan>
          </Text>
          <Text animationName='depth3Title' className={'cursor-default font-serif depth3  titleText opacity-0 titleText2 scale-90'} fill="#FFF5EA" style={{ whiteSpace: "pre" }} fontSize="47.3029" letterSpacing="0em">
            <tspan className={`${shadow ? 'drop-shadow-[0_0px_20px_#FFF5EAFF] ' : ''}`} x="353.311" y="237.609">
              unique
            </tspan>
          </Text>
          <Text animationName='depth2Title' className={'cursor-default font-serif depth1  titleText opacity-0 titleText2 scale-90'} fill="#FFF5EA" style={{ whiteSpace: "pre" }} fontSize="75" letterSpacing="0em">
            <tspan className={`${shadow ? 'drop-shadow-[0_0px_20px_#FFF5EAFF] ' : ''}`} x="92.4258" y="257.07">
              &#38;
            </tspan>
          </Text>
          <Text animationName='depth2Title' className={'cursor-default font-serif depth2  titleText opacity-0 titleText2 scale-90'} fill="#FFF5EA" style={{ whiteSpace: "pre" }} fontSize="76" letterSpacing="0em">
            <tspan className={`${shadow ? 'drop-shadow-[0_0px_20px_#FFF5EAFF] ' : ''}`} x="187.109" y="284.604">
              exp
            </tspan>
          </Text>
          <Text animationName='depth3Title' className={'cursor-default font-serif depth3  titleText opacity-0 titleText2 scale-90'} fill="#FFF5EA" style={{ whiteSpace: "pre" }} fontSize="50" letterSpacing="0em">
            <tspan className={`${shadow ? 'drop-shadow-[0_0px_20px_#FFF5EAFF] ' : ''}`} x="118.287" y="326.278">
              erim
            </tspan>
          </Text>
          <Text animationName='depth1Title' className={'cursor-default font-serif depth1  titleText opacity-0 titleText2 scale-90'} fill="#FFF5EA" style={{ whiteSpace: "pre" }} fontSize="90.0862" letterSpacing="0em">
        ...
        {/* <Text animationName="depth3Title" className={`cursor-default font-serif depth3 titleText opacity-0 titleText1 scale-90`} fill="#FFF5EA" style={{ whiteSpace: "pre" }} fontSize="42.2727" letterSpacing="0em">
          ...
          <Text animationName="depth1Title" className={`cursor-default font-serif depth1 titleText  opacity-0 titleText1 scale-90`} fill="#FFF5EA" style={{ whiteSpace: "pre" }} fontSize="87.8834" letterSpacing="0em">
            <tspan className={` ${shadow ? 'drop-shadow-[0_0px_20px_#FFF5EAFF] ' : ''}`} x="96" y="180.1653">
              photo
            </tspan>
          </Text>
          <Text animationName="depth2Title" className={`cursor-default font-serif depth2 titleText opacity-0 titleText1 scale-90`} fill="#FFF5EA" style={{ whiteSpace: "pre" }} fontSize="72.5438" letterSpacing="0em">
