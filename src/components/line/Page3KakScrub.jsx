...
export default function Page3KakScrub({ scrollMin, scrollMax, scrubTl }) {
  ...
  return (<>
    <svg className='fixed left-[80%] top-[calc(60%+0.92*0.7*0.19*100vw)] md:top-[calc(50%+0.92*0.3*0.19*100vw)] -translate-x-1/2 w-[10%] md:w-[2.8%] svgKakScrub' viewBox="0 0 39 235" fill="none">
