  ...
  return (
    <div className={'page3photosContainer fixed w-screen h-screen'} >
      <div className='w-full h-full page3photosContainerInner'>
        ...
        <ArtImage n={0} alt='' src='/images/mainpageArt1.jpg' imagePosition={`object-[50%,-5lvh] lg:object-[50%,-20vh]`} className={'w-[calc(0.920*70vw)] md:w-[calc(0.920*30vw)] left-[70%] top-[50%]  md:left-[80%] md:top-[50%] -translate-x-1/2'} />
        ...
        <ArtImage n={1} alt='' src='/images/mainpageArt2.jpg' imagePosition={`object-[50%,-10lvh] lg:object-[50%,-30vh]`} className={'w-[calc(0.752*70vw)] md:w-[calc(0.752*30vw)]  left-1/2 top-[35%] md:left-1/2 md:top-[42%] -translate-x-1/2'} />
        <ArtImage n={2} alt='' src='/images/mainpageArt3.jpg' imagePosition={`object-[50%,-12lvh] lg:object-[50%,-35vh]`} className={'w-[calc(0.890*70vw)] md:w-[calc(0.890*30vw)] left-[30%] top-[10%] md:left-[20%] md:top-[23%] -translate-x-1/2'} />
        {/* translate-y-64
translate-y-28
translate-y-36 */}
      </div>
