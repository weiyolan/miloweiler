  ...
  return (
    ...
    <Parallax small duration={2.8} scope='btsPhotos' timeline={timeline} start='100% 100%' className={`page1photosContainer fixed w-screen h-screen top-0 text-primary ${className ? className : ''}`}>
      <div className='page1photosContainerInner w-full h-full'>
        ...
        <Page1Image alt='' src='/images/page1photo5.jpg' width='265' height='366' className={`scale0 depth2   w-[12vw] absolute left-[45%] top-[60%]`} style={{}} sizes='(max-width: 648px) 20vw, 10vw' />
        <Page1Image alt='' src='/images/page1photo.jpg' width='265' height='366' className={`scale0 depth1    w-[10vw] absolute left-[50%] top-[25%]`} style={{}} sizes='(max-width: 648px) 20vw, 10vw' />
