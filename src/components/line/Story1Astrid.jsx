...
export default function Story1Astrid({ scrollMin, scrollMax, speed, setSvgHeight, setSvgWidth, banner }) {
  ...
  return (<>
    ...
    <h1 className="text-xl text-primary">{fakeScroll1.scroll}</h1>
    <h2 className="text-xl text-right text-primary">{fakeScroll2.scroll}</h2>
  </>
  )
}