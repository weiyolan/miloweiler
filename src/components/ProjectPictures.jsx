...
export default function ProjectPictures({ images, handleVisibility, visibleItem }) {
  ...
  return (
    // <ReactLenis root options={{}}> overscroll-x-contain lg:overscroll-y-contain
      <div ref={container}  className={`relative ignore-swipe project-pictures  no-scrollbar select-none w-full h-fit lg:h-full lg:w-fit  overflow-x-scroll lg:overflow-x-visible lg:overflow-y-scroll`}>
