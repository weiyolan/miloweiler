...
export default function Navigation() {
  ...
  return (
    ...
    <div className={`fixed w-full top-0 justify-center flex navBar`}>
      <div className={`${darkMode ? 'bg-[#FFEAD6]/1' : 'bg-[#FFEAD6]/20'} backdrop-blur-sm w-full h-[160%] bottom-0 rounded-b-[100%] absolute -translate-x-4 invisble opacity-0 navBackground`} />
